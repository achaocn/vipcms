...
<div class="big">
	...
	<header>
        <a href="/"><img src="__STATIC__/tkjidicms/wap/img/detail/deback.png" /></a>
    </header>
  ...
  <else />
   <div class="detail">
        ...
        <div class="de-bottom">
            <a href="/?m=quan&a=quan_browser&link={:base64_encode($info['couponlink'])}"><div class="de-name">
                <div class="name-img"><img src="__STATIC__/tkjidicms/images/v_tm{:($info['tmall']==1)?1:0}.png"></div>
                <p class="name-text">{$info['buss_name']}</p>
            </div>
            </a>
            <div class="explain" style="text-align:right;">已有{$info['sales']}人购买</div>
  ...
  <div class="footer" style="display:none">
      ...
      <if condition="$info['price_youhuiquan'] eq '无券'">
	...
	function is_weixin(){
		...
		if(getOS()){
			...
			if(value==""||value==undefined)
			{
				...
				console.log("22222"+data.couponLink+"==="+data.title);
				$.ajax({
					type: "POST",
					url:'/?m=pro&a=erheyi',
					data: data,
