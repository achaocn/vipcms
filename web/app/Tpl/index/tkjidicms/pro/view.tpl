    ...
    <div class="v_detail_out">
        <div class="v_detail">
            ...
            <div class="pic_det">
                 ...
                 <a href="{$info['couponlink']}" target="_blank" style="float:left"><img src="{$info['thumb']}" alt="{$info['buss_name']}" width="440"></a>
                
                <div class="pic_mid">
                    <div class="pic_top">
                        <img src="__STATIC__/tkjidicms/images/v_tm{$info['tmall']}.png" alt="">
                        <span> <a href="{$info['couponlink']}" target="_blank" style="color:#555">{$info['buss_name']}</a></span>
                    </div>
