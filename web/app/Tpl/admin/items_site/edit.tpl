        ...
        <tr>
            ...
            <td>
                <switch name="config.type">
                    <case value="text">
                        <input type="text" name="{$key}" class="input-text" size="30" value="{$info['config'][$key]}">&nbsp;&nbsp;<span class="gray"><a href="http://daxue.tkjidi.com/forum.php?mod=viewthread&tid=511&extra=page%3D1" target="_blank">设置教程</a></span>
                    </case>
                    <case value="select">
                        <select name="{$key}">
