    ...
    <table width="100%" cellspacing="0">
        <thead>
            <tr>
                ...
                <th align=""><span data-tdtype="order_by" data-field="score">积分</span></th>
    	...
    	<tbody>
            ...
            <tr>
                ...
                <td align="center"><span data-tdtype="edit" data-field="score" data-id="{$val.id}" class="tdedit">{$val.score}</span></td>
