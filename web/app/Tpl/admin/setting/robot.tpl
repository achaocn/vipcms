	...
	<form id="info_form" action="{:u('setting/edit')}" method="post">
		<table width="100%" class="table_form contentWrap">
			...
			<tr>
				...
				<td><textarea rows="10" cols="100" name="setting[cookie]">{:C('ftx_cookie')}</textarea>&nbsp;&nbsp;&nbsp;<span class="gray"><a href="http://daxue.tkjidi.com" target="_blank">点此查看获取教程</a></span></td>
			</tr>
			<tr>
		  ...
		  推广位教程<a href="http://daxue.tkjidi.com" target="_blank">http://daxue.tkjidi.com </a></td>
		  </tr>
		  <tr>
