    ...
    <table width="100%" cellspacing="0">
        <thead>
            <tr>
                ...
                <th width="55"><span tdtype="order_by" fieldname="id">ID</span></th>
				<th width="50" align="center">缩略图</th>
                <th width="336" align="left"><span data-tdtype="order_by" data-field="title">商品名称</span></th>
                <th width="96" align="center">状态</th>
                ...
                <th width="102" align="left"><span data-tdtype="order_by" data-field="user_num">每人限兑</span></th>
                <th width="180" align="center">分类名称</th>
				<th width="76" align="left"><span data-tdtype="order_by" data-field="ordid">排序</span></th>
    	...
    	<tbody>
            ...
            <tr>
                ...
                <td align="center">
                <img data-tdtype="toggle" data-id="{$val.id}" data-field="pass" data-value="{$val.pass}" src="__STATIC__/images/admin/toggle_<if condition="$val.pass eq 0">disabled<else/>enabled</if>.gif" />
                </td>
