...
<div class="pad_lr_10" >
<form action="{:u('youhuiquan/clear')}" method="post" name="searchform" id="info_form">
...
<div class="pad_lr_10" >
<form action="{:u('youhuiquan/delete_search')}" method="post" name="searchform" id="info_form">
	<table width="100%" cellspacing="0" class="table_form">
		<tbody>
			<tr>
