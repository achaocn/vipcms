        ...
        <div class="J_panes">
            ...
            <div class="content_list pad_10" style="display:none;">
			 <table width="100%" class="table_form">
			   <thead>
                    <tr>
                        <th colspan="2" align="left">8.8包邮首页可直接调用的标签</th>
                    </tr>
                    </thead>
                    <tr>
                        <th>Title</th>
			 ...
			 <div class="content_list pad_10" style="display:none;">
			  <table width="100%" class="table_form">
			   <thead>
                    <tr>
                        <th colspan="2" align="left">领券直播首页可直接调用的标签</th>
                    </tr>
                    </thead>
                    <tr>
                        <th>Title</th>
                ...
                <table width="100%" class="table_form">
                    <thead>
                    <tr>
                        <th colspan="2" align="left">领券直播可直接调用的标签</th>
                    </tr>
                    </thead>
					<tr>
                        <td></td>
			...
			<div class="content_list pad_10" style="display:none;">
			 <table width="100%" class="table_form">
			       <thead>
                    <tr>
                        <th colspan="2" align="left">20封顶首页可直接调用的标签</th>
                    </tr>
                    </thead>
                    <tr>
                        <th>Title</th>
			 ...
			 <table width="100%" class="table_form">
			   <thead>
                    <tr>
                        <th colspan="2" align="left">晒单广场首页可直接调用的标签</th>
                    </tr>
                    </thead>
                    <tr>
                        <th>Title</th>
            ...
            <div class="content_list pad_10" style="display:none;">
			 <table width="100%" class="table_form">
			   <thead>
                    <tr>
                        <th colspan="2" align="left">看货首页可直接调用的标签</th>
                    </tr>
                    </thead>
                    <tr>
                        <th>Title</th>
                        <td><textarea name="seo_config[video_index][title]" cols="80" rows="2">{$seo_config.video_index.title}</textarea></td>
                    </tr>
                    <tr>
                        <th>Keywords</th>
                        <td><textarea name="seo_config[video_index][keywords]" cols="80" rows="2">{$seo_config.video_index.keywords}</textarea></td>
                    </tr>
                    <tr>
                        <th>Description</th>
                        <td><textarea name="seo_config[video_index][description]" cols="80" rows="3">{$seo_config.video_index.description}</textarea></td>
                    </tr>
                </table>
